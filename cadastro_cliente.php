        ...
        <div class="container">
          <div class="row" style="margin-top: 100px ;">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <input type="number" name="numero" class="form-control" placeholder="Número" aria-label="Last name">
              </div>
              ...
              <div class="col">
              <input type="text" name="numerotel" class="form-control" placeholder="numero TEL" aria-label="Last name">
              </div>
              <div class="col-12">
